...
RETAIL_CONFIG_DWORD_INFO(EXTERNAL_EnableAVX10v1,                W("EnableAVX512v1"),            1, "Allows AVX10v1+ hardware intrinsics to be disabled")
RETAIL_CONFIG_DWORD_INFO(EXTERNAL_EnableAVX10v1_256,            W("EnableAVX10v1_256"),         1, "Allows AVX10v1_256+ hardware intrinsics to be disabled")
RETAIL_CONFIG_DWORD_INFO(EXTERNAL_EnableAVX10v1_512,            W("EnableAVX10v1_512"),         1, "Allows AVX10v1_512+ hardware intrinsics to be disabled")
