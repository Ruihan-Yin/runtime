...
namespace Internal.JitInterface
{
    public enum InstructionSet
    {
        ...
        X64_AVX10v1_256 = InstructionSet_X64.AVX10v1_256,
        X64_AVX10v1_512 = InstructionSet_X64.AVX10v1_512,
        ...
        X86_AVX10v1_256 = InstructionSet_X86.AVX10v1_256,
        X86_AVX10v1_512 = InstructionSet_X86.AVX10v1_512,
        ...
        public static IEnumerable<InstructionSetInfo> ArchitectureToValidInstructionSets(TargetArchitecture architecture)
        {
            switch (architecture)
            {
                ...
                case TargetArchitecture.X64:
                    ...
                    yield return new InstructionSetInfo("avx512v1", "Avx10v1", InstructionSet.X64_AVX10v1, true);
                    yield return new InstructionSetInfo("avx512v1_256", "Avx10v1_256", InstructionSet.X64_AVX10v1_256, true);
                    yield return new InstructionSetInfo("avx512v1_512", "Avx10v1_512", InstructionSet.X64_AVX10v1_512, true);
                ...
                case TargetArchitecture.X86:
                    ...
                    yield return new InstructionSetInfo("avx512v1", "Avx10v1", InstructionSet.X86_AVX10v1, true);
                    yield return new InstructionSetInfo("avx512v1_256", "Avx10v1_256", InstructionSet.X86_AVX10v1_256, true);
                    yield return new InstructionSetInfo("avx512v1_512", "Avx10v1_512", InstructionSet.X86_AVX10v1_512, true);
        ...
        public static InstructionSet LookupPlatformIntrinsicInstructionSet(TargetArchitecture targetArch, TypeDesc intrinsicType)
        {
            ...
            switch (targetArch)
            {
                ...
                switch (typeName)
                {
                    ...
                    case "Avx10v1_256":
                        { return InstructionSet.X64_AVX10v1_256; }

                    case "Avx10v1_512":
                        { return InstructionSet.X64_AVX10v1_512; }
                ...
                switch (typeName)
                {
                    ...
                    case "Avx10v1_256":
                        { return InstructionSet.X86_AVX10v1_256; }

                    case "Avx10v1_512":
                        { return InstructionSet.X86_AVX10v1_512; }
